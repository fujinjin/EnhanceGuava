...
public class GenerateEqualsHashCodeWizard extends AbstractWizard {
    ...
    public GenerateEqualsHashCodeWizard(Project project, PsiClass aClass, boolean needEquals, boolean needHashCode, EqualsAndHashCodeType type) {
