...
class GenerateEqualsHashCodeActionHandler extends GenerateMembersHandlerBase {

    static
    final String METHODS_DEFINED_FOR_ANONYMOUS_CLASS = 'Methods "boolean equals(Object)" or "int hashCode()" are already defined \nfor this anonymous class. Do you want to delete them and proceed?'
    static
    final String METHODS_DEFINED_FOR_CLASS = 'Methods "boolean equals(Object)" or "int hashCode()" are already defined\nfor class %s. Do you want to delete them and proceed?'
    ...
    GenerateEqualsHashCodeWizardFactory factory
    ...
    GenerateEqualsHashCodeActionHandler(HashCodeGenerator hashCodeGenerator, EqualsGenerator equalsGenerator,
                                        TypeChooser typeChooser, GenerateEqualsHashCodeWizardFactory factory) {
        super('')
    ...
    protected List<? extends GenerationInfo> generateMemberPrototypes(PsiClass psiClass, ClassMember[] originalMembers) throws IncorrectOperationException {
        PsiMethod hashCodeMethod = hashCodeGenerator.hashCodeMethod(hashCodeFields as List, psiClass)
    ...
    protected ClassMember[] chooseOriginalMembers(PsiClass aClass, Project project, Editor editor) {
        ...
        GenerateEqualsHashCodeWizard wizard = factory.createWizard(project, aClass, needEquals, needHashCode, typeChooser.chooseType(aClass))
